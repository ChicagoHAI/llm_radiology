...
torchrun --nproc_per_node=4 --master_port=4001 finetune.py \
    ...
    --bf16 True \
    --output_dir /data/dangnguyen/report_generation/llm_radiology/radiology_models \
    --num_train_epochs 3 \
...
# torchrun --nproc_per_node=4 --master_port=4001 finetune.py \
#     --model_name_or_path /data/LLAMA_hf/llama-13b \
#     --data_path /data/dangnguyen/report_generation/mimic_data/finetune_llm/finetune_imp.json \
#     --bf16 True \
#     --output_dir /data/dangnguyen/report_generation/llm_radiology/radiology_models \
#     --num_train_epochs 3 \
...
#     --weight_decay 0. \
#     --warmup_ratio 0.03 \
#     --deepspeed "./configs/offload_param.json" \
#     --tf32 True