...
if __name__ == "__main__":
    instruct_path = '/data/dangnguyen/report_generation/XrayGPT/prompts/mimic/report_clean_rules/rewrite1_instructions.txt'
    examples_path = '/data/dangnguyen/report_generation/XrayGPT/prompts/mimic/report_clean_rules/rewrite1_sen_fewshot.txt'

    test_file = "/data/dangnguyen/report_generation/mimic_data/mimic_train_impressions_sentence.csv"
    data = pd.read_csv(test_file, nrows=100)[['report']].drop_duplicates()
    print(len(data))
    ...
    output_file = "rewrite1_t5_xxl.jsonl"
