...
def main(args):
    ...
    for item1 in tqdm(os.listdir(in_files)[::-1]):
...
def parse_args():
    ...
    parser.add_argument('--jpgs', type=str, default='/net/scratch/chacha/physionet.org/files/mimic-cxr-jpg', help='A path to MIMIC-CXR-JPG')
